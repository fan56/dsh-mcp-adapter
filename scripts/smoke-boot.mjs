...
const ownName = pkg.name // @aiwayds/dsh-mcp-adapter

const work = mkdtempSync(path.join(tmpdir(), 'dsh-mcp-adapter-smoke-'))
...
if (dumpAfter.stdout.includes('dsh-mcp-adapter')) {
